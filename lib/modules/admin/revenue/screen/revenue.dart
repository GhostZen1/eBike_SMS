...
class _RevenueScreenState extends State<RevenueScreen> {
  ...
  void _fetchTransactions([String? selectedMonthYear]) async {
    try {
      ...
      setState(() {
        ...
        totalRevenue = _calculateTotalRevenueForMonth(selectedMonthYear ?? DateFormat('MMMM yyyy').format(DateTime.now())); // Recalculate total revenue
      });
  ...
  void _filterTransactions(String query) {
    if (query.isEmpty) {
      setState(() {
        filteredTransactions = transactions;  // Show all transactions when search is empty
      });
    } else {
      setState(() {
  ...
  void _onDonutChartClick() {
    setState(() {
      ...
      _fetchTransactions(selectedMonthYear); // Fetch transactions for the new month
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // Search Bar
            TextField(
              controller: _searchController, // Attach controller to the text field
            ...
            filteredTransactions.isEmpty
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      print('Displaying transaction: ${transaction.toString()}');
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Text('Time: ${transaction.obtainedRideTime}'),
                                ],
                              ),
                              const SizedBox(height: 8),
                              Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Text('RM ${transaction.transactionTotal}'),
                                  ],
                                ),
                              ),
                            ],
